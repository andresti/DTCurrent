...
class DTCurrentData(object):
  ...
  def current_vs_timestamp(self, wheel=None, station=None, sector=None, superlayer=None, layer=None, wire='wires'):
    xs = self.timestamps
    ys = self.get(wheel=wheel, station=station, sector=sector, superlayer=superlayer, layer=layer, wire=wire)
    return (xs, ys)  
